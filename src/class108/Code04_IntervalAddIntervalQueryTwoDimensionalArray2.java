...
// 如下实现完全正确，但是洛谷平台对空间卡的很严，只有使用C++能全部通过
// 甚至C++的实现稍微不注意读写效率也无法通过
// java的版本就没有能完全通过的，这是洛谷平台根本没有照顾各种语言的实现所导致的
// 在真正笔试、比赛时，一定是兼顾各种语言的，该实现一定能通过
// 该实现所有测试用例的答案都正确
...
public class Code04_IntervalAddIntervalQueryTwoDimensionalArray2 {

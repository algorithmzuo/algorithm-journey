...
// 博物馆劫案，java版
// 给定一个正数k，假设当前商品集合为s，可以随意挑选商品
// 总重量不超过m的情况下，能得到的最大价值，定义为best(m)
// 定义，f(s) = ∑(m = 1...k) ( best(m) * BASE的m-1次方 % MOD )
// 其中BASE = 10000019，MOD = 1000000007
// 给定n件商品，编号1~n，每种商品给定v和w，每件商品都加入商品集合s
// 接下来有q个操作，每种操作是如下三种类型中的一种
// 操作 1 x y : 集合s中增加价值x、重量y的商品，编号自增即可
// 操作 2 x   : 集合s中删除编号为x的商品
// 操作 3     : 查询当前的f(s)

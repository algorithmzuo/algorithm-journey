...
// 火星商店，C++版
// 有n个商店，编号1~n，初始时每个商店只有一种商品，给定每个商店中唯一商品的价格
// 有m条操作，每种操作是如下两种类型中的一种
// 操作 0 s v     : 只有操作0能让天数+1，第s号商店，这天新增了价格为v的商品
// 操作 1 l r x d : 客人只在商店[l..r]中选择一件商品，只购买d天内的出现的商品
//                  所有符合要求的商品中，打印 商品的价格 ^ x 的最大值
// 注意，只有操作0能让天数+1，操作1不会增加天数
// 0 <= 所有数据 <= 10^5

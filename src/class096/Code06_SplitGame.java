...
// 当前玩家从i号瓶中拿出1颗糖豆，分裂成2颗糖豆，并且往j、k瓶子中各放入1颗，分裂的糖豆继续无差别
// 要求i号瓶一定要有糖豆，如果j == k，那么相当于从i号瓶中拿出1颗，向另一个瓶子放入了2颗
// 如果轮到某个玩家发现所有糖豆都在n-1号瓶里，导致无法行动，那么该玩家输掉比赛
// 先手希望知道，第一步如何行动可以保证自己获胜，要求返回字典序最小的行动
// 比如第一步从0号瓶拿出1棵糖豆，并且往2、3号瓶中各放入1颗，可以确保最终自己获胜
// 比如第一步从0号瓶拿出1棵糖豆，并且往11、13号瓶中各放入1颗，也可以确保自己获胜
